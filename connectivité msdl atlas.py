...
os.chdir("E:/COURS-IMT/CODEV_Recherche/Données_Analysées/fmriprep/sub-17NA/func")
#data_active = "sub-02CB_task-movie_run-1_space-MNI152NLin2009cAsym_desc-preproc_bold.nii.gz"
data_rest="sub-17NA_task-rest_run-3_space-MNI152NLin2009cAsym_desc-preproc_bold.nii.gz"
...
coordinates = plotting.find_probabilistic_atlas_cut_coords(atlas_img)
